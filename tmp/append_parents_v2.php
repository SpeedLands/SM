...
foreach ($groups as $group => $studentNames) {
    ...
    try {
        ...
        if (! $sheet) {
            echo "Error: Sheet 'Padres' not found in $file.\n";
        ...
        foreach ($studentNames as $name) {
            ...
            if (! $data) {
                echo "Warning: Student data for $name not found in JSON.\n";
            ...
            if ($phone1) {
                ...
                echo "  No Madre phone for $name (Value: ".($data[1] ?? 'NULL').")\n";
            }
            ...
            if ($phone2) {
                ...
                echo "  No Padre phone for $name (Value: ".($data[2] ?? 'NULL').")\n";
            }
        }
