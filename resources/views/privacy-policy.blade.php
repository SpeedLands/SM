    ...
    <body class="antialiased bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 min-h-screen selection:bg-blue-500/30">
        ...
        <main class="max-w-4xl mx-auto px-6 py-16 md:py-24">
            ...
            <div class="mb-16 text-center">
                ...
                <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight mb-4 bg-linear-to-br from-zinc-900 via-zinc-800 to-zinc-600 dark:from-white dark:via-zinc-200 dark:to-zinc-500 bg-clip-text text-transparent">
            ...
            <div class="space-y-12">
                ...
                <section class="p-8 bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-3xl shadow-sm">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="size-10 bg-red-500/10 rounded-xl flex items-center justify-center border border-red-500/20 text-red-600 dark:text-red-400 font-bold text-sm">9</div>
                        <h2 class="text-xl font-bold tracking-tight">Cierre de Cuenta y Retención de Datos</h2>
                    </div>
                    <div class="text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed space-y-3">
                        <p>Los usuarios tienen el derecho de solicitar el cese del uso de sus datos y la cancelación de acceso a la plataforma.</p>
                        <p>Para iniciar este proceso, puede hacerlo solicitándolo formalmente por los siguientes medios (incluso si ya no tiene la aplicación instalada):</p>
                        <ul class="list-disc list-inside space-y-2">
                            <li>Enviando una solicitud explícita de "Cancelación de Cuenta" al correo electrónico listado en la sección de Contacto.</li>
                            <li>A través de la administración física de la institución educativa.</li>
                        </ul>
                        <p><strong>Nota importante sobre la eliminación de datos (Cumplimiento Regulatorio):</strong> Como la plataforma es utilizada por una institución educativa oficial, los expedientes académicos, reportes disciplinarios y la identidad de los alumnos y tutores están sujetos a normativas de retención obligatoria estatales y federales (SEDU / SEP). Por lo tanto, al solicitar la baja, <strong>su cuenta será bloqueada e inhabilitada permanentemente</strong>, impidiendo cualquier acceso posterior, pero los datos históricos <strong>serán retenidos por motivos legítimos de cumplimiento regulatorio y administrativo</strong>, conforme lo permite la ley y las normativas de Google Play.</p>
                    </div>
                </section>
                ...
                <section class="p-8 bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-3xl shadow-sm">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="size-10 bg-amber-500/10 rounded-xl flex items-center justify-center border border-amber-500/20 text-amber-600 dark:text-amber-400 font-bold text-sm">10</div>
                ...
                <section class="p-8 bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-3xl shadow-sm">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="size-10 bg-blue-500/10 rounded-xl flex items-center justify-center border border-blue-500/20 text-blue-600 dark:text-blue-400 font-bold text-sm">11</div>
                ...
                <section class="p-8 bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-3xl shadow-sm">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="size-10 bg-violet-500/10 rounded-xl flex items-center justify-center border border-violet-500/20 text-violet-600 dark:text-violet-400 font-bold text-sm">12</div>
                ...
                <section class="p-8 bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-3xl shadow-sm">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="size-10 bg-emerald-500/10 rounded-xl flex items-center justify-center border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 font-bold text-sm">13</div>
                        <h2 class="text-xl font-bold tracking-tight">Contacto e Información del Desarrollador</h2>
                    </div>
                    <div class="text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed space-y-3">
                        <p>Para enviar consultas, dudas sobre esta Política de Privacidad, ejercer sus derechos ARCO, o solicitar la <strong>eliminación de su cuenta y datos personales</strong>, por favor comuníquese con el equipo de soporte técnico / administración de la institución a través del siguiente punto de contacto oficial:</p>
                        <div class="p-4 bg-zinc-50 dark:bg-zinc-800/50 rounded-xl border border-zinc-100 dark:border-zinc-700/50 mt-4">
                            <ul class="space-y-2">
                                <li><strong>Entidad Responsable:</strong> Sec. Dr. Rogelio Montemayor Seguy No.5</li>
                                <li><strong>Correo Electrónico de Privacidad:</strong> 05des0074c@seducoahuila.gob.mx</li>
                                <li><strong>Teléfono de Soporte:</strong> +52 1 878 122 3015</li>
                                <li><strong>Sitio Web:</strong> <a href="{{ url('/') }}" class="text-blue-600 dark:text-blue-400 underline hover:no-underline">{{ url('/') }}</a></li>
                            </ul>
                        </div>
                    </div>
                </section>
